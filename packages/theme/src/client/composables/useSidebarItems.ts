...
export const setupSidebarItems = (): void => {
  ...
  const frontmatter = usePageFrontmatter<WayThemeNormalPageFrontmatter>()
...
export const resolveSidebarItems = (
  frontmatter: WayThemeNormalPageFrontmatter,
  themeLocale: WayThemeData
): ResolvedSidebarItem[] => {
